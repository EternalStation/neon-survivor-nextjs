...
export const INITIAL_TRACKS: Record<string, string[]> = {
    '80BPM': [
        '/audio/80BPM/Crush Protocol 80 BPM.mp3',
        '/audio/80BPM/Grinding In The Grid 80BPM.mp3',
        '/audio/80BPM/Rain on Chrome 80BPM.mp3',
        '/audio/80BPM/Violet Datastream 80BPM.mp3',
        '/audio/80BPM/Violet Datastream v2 80BPM .mp3'
    ],
    '100BPM': [
        '/audio/100BPM/Defensive Arena 100PBM.mp3',
        '/audio/100BPM/Event Horizon Hymn 100BPM.mp3',
        '/audio/100BPM/Iron Cathedral 100BPM.mp3'
    ],
    '120BPM': [
        '/audio/120BPM/Economic Arena 120BPM.mp3'
    ],
    '140BPM': [
        '/audio/140BPM/Combat Arena 140BPM.mp3',
        '/audio/140BPM/Neon Blood Circuit 140BPM.mp3'
    ],
    '160BPM': [
        '/audio/160BPM/Digital Siege Protocol 160BPM.mp3'
    ],
};
