...
export const PERK_POOLS: Record<number, PerkDef[]> = {
    ...
    3: [
        ...
        { id: 'lvl3_eco_bro', description: 'Neighboring a Broken Meteorite found in ECO HEX', ranges: { Broken: { min: 4, max: 8 }, Damaged: { min: 7, max: 11 }, New: { min: 10, max: 15 } } },
        { id: 'lvl3_eco_dam', description: 'Neighboring a Damaged Meteorite found in ECO HEX', ranges: { Broken: { min: 4, max: 8 }, Damaged: { min: 7, max: 11 }, New: { min: 10, max: 15 } } },
        { id: 'lvl3_eco_new', description: 'Neighboring a New Meteorite found in ECO HEX', ranges: { Broken: { min: 4, max: 8 }, Damaged: { min: 7, max: 11 }, New: { min: 10, max: 15 } } },
        { id: 'lvl3_com_bro', description: 'Neighboring a Broken Meteorite found in COM HEX', ranges: { Broken: { min: 4, max: 8 }, Damaged: { min: 7, max: 11 }, New: { min: 10, max: 15 } } },
        { id: 'lvl3_com_dam', description: 'Neighboring a Damaged Meteorite found in COM HEX', ranges: { Broken: { min: 4, max: 8 }, Damaged: { min: 7, max: 11 }, New: { min: 10, max: 15 } } },
        { id: 'lvl3_com_new', description: 'Neighboring a New Meteorite found in COM HEX', ranges: { Broken: { min: 4, max: 8 }, Damaged: { min: 7, max: 11 }, New: { min: 10, max: 15 } } },
        { id: 'lvl3_def_bro', description: 'Neighboring a Broken Meteorite found in DEF HEX', ranges: { Broken: { min: 4, max: 8 }, Damaged: { min: 7, max: 11 }, New: { min: 10, max: 15 } } },
        { id: 'lvl3_def_dam', description: 'Neighboring a Damaged Meteorite found in DEF HEX', ranges: { Broken: { min: 4, max: 8 }, Damaged: { min: 7, max: 11 }, New: { min: 10, max: 15 } } },
        { id: 'lvl3_def_new', description: 'Neighboring a New Meteorite found in DEF HEX', ranges: { Broken: { min: 4, max: 8 }, Damaged: { min: 7, max: 11 }, New: { min: 10, max: 15 } } },
    ],
    4: [
        // LVL4: Secondary Neighbor Quality from Arena
        { id: 'lvl4_eco_bro', description: 'Secondary neighboring a Broken Meteorite found in ECO HEX', ranges: { Broken: { min: 7, max: 12 }, Damaged: { min: 10, max: 14 }, New: { min: 13, max: 19 } } },
        { id: 'lvl4_eco_dam', description: 'Secondary neighboring a Damaged Meteorite found in ECO HEX', ranges: { Broken: { min: 7, max: 12 }, Damaged: { min: 10, max: 14 }, New: { min: 13, max: 19 } } },
        { id: 'lvl4_eco_new', description: 'Secondary neighboring a New Meteorite found in ECO HEX', ranges: { Broken: { min: 7, max: 12 }, Damaged: { min: 10, max: 14 }, New: { min: 13, max: 19 } } },
        { id: 'lvl4_com_bro', description: 'Secondary neighboring a Broken Meteorite found in COM HEX', ranges: { Broken: { min: 7, max: 12 }, Damaged: { min: 10, max: 14 }, New: { min: 13, max: 19 } } },
        { id: 'lvl4_com_dam', description: 'Secondary neighboring a Damaged Meteorite found in COM HEX', ranges: { Broken: { min: 7, max: 12 }, Damaged: { min: 10, max: 14 }, New: { min: 13, max: 19 } } },
        { id: 'lvl4_com_new', description: 'Secondary neighboring a New Meteorite found in COM HEX', ranges: { Broken: { min: 7, max: 12 }, Damaged: { min: 10, max: 14 }, New: { min: 13, max: 19 } } },
        { id: 'lvl4_def_bro', description: 'Secondary neighboring a Broken Meteorite found in DEF HEX', ranges: { Broken: { min: 7, max: 12 }, Damaged: { min: 10, max: 14 }, New: { min: 13, max: 19 } } },
        { id: 'lvl4_def_dam', description: 'Secondary neighboring a Damaged Meteorite found in DEF HEX', ranges: { Broken: { min: 7, max: 12 }, Damaged: { min: 10, max: 14 }, New: { min: 13, max: 19 } } },
        { id: 'lvl4_def_new', description: 'Secondary neighboring a New Meteorite found in DEF HEX', ranges: { Broken: { min: 7, max: 12 }, Damaged: { min: 10, max: 14 }, New: { min: 13, max: 19 } } },
    ],
    5: [
    ...
    6: [
        ...
        { id: 'lvl6_bro_eco_eco', description: 'Neighboring a Broken Meteorite. Connects Eco & Eco Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_bro_eco_com', description: 'Neighboring a Broken Meteorite. Connects Eco & Com Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_bro_eco_def', description: 'Neighboring a Broken Meteorite. Connects Eco & Def Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_bro_com_com', description: 'Neighboring a Broken Meteorite. Connects Com & Com Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_bro_com_def', description: 'Neighboring a Broken Meteorite. Connects Com & Def Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_bro_def_def', description: 'Neighboring a Broken Meteorite. Connects Def & Def Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_dam_eco_eco', description: 'Neighboring a Damaged Meteorite. Connects Eco & Eco Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_dam_eco_com', description: 'Neighboring a Damaged Meteorite. Connects Eco & Com Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_dam_eco_def', description: 'Neighboring a Damaged Meteorite. Connects Eco & Def Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_dam_com_com', description: 'Neighboring a Damaged Meteorite. Connects Com & Com Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_dam_com_def', description: 'Neighboring a Damaged Meteorite. Connects Com & Def Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_dam_def_def', description: 'Neighboring a Damaged Meteorite. Connects Def & Def Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_new_eco_eco', description: 'Neighboring a New Meteorite. Connects Eco & Eco Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_new_eco_com', description: 'Neighboring a New Meteorite. Connects Eco & Com Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_new_eco_def', description: 'Neighboring a New Meteorite. Connects Eco & Def Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_new_com_com', description: 'Neighboring a New Meteorite. Connects Com & Com Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_new_com_def', description: 'Neighboring a New Meteorite. Connects Com & Def Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
        { id: 'lvl6_new_def_def', description: 'Neighboring a New Meteorite. Connects Def & Def Hexes', ranges: { Broken: { min: 16, max: 23 }, Damaged: { min: 19, max: 25 }, New: { min: 23, max: 30 } } },
    ]
};
