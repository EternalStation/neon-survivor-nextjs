...
export const UI_TRANSLATIONS = {
    en: {
        ...
        legendaries: {
            ...
            BloodForgedCapacitor: { name: 'THE BLOOD-FORGED CAPACITOR', desc: 'A dark resonance between Crimson Feast and Kinetic Battery. Converts kinetic trauma into vital essence.' },
            perks: {
                ...
                BloodForgedCapacitor: [
                    ...
                    "1% Lifesteal from Kinetic Battery DMG",
                    "5% chance for zombie to cast Kinetic shockwave after consuming an enemy",
                    "GROUP:CRIMSON FEAST",
    ...
    ru: {
        ...
        legendaries: {
            ...
            BloodForgedCapacitor: { name: 'КРОВОКОВАННЫЙ КОНДЕНСАТОР', desc: 'Темный резонанс между Багровым Пиром и Кинетической Батареей. Превращает кинетическую травму в жизненную эссенцию.' },
            perks: {
                ...
                BloodForgedCapacitor: [
                    ...
                    "1% Вампиризм от урона Кинетической Батареи",
                    "5% шанс для зомби вызвать Кинетическую волну после поедания врага",
                    "GROUP:БАГРОВЫЙ ПИР",
