                                    ...
                                    <div className="class-filter-row">
                                        ...
                                        {PLAYER_CLASSES.map(cls => (
                                            <button
                                                ...
                                                title={getClassName(cls.id, language).toUpperCase()}
                                ...
                                <table className="leaderboard-table">
                                    ...
                                    <tbody>
                                        {filteredEntries.map((entry, index) => {
                                            ...
                                            const normalizedCause = (entry.death_cause || '').toUpperCase();
                                            const causeClass = normalizedCause === 'EVACUATED' ? 'cause-evacuated' : 'cause-killed';
                                            ...
                                            return (
                                                <React.Fragment key={entry.id}>
                                                    ...
                                                    >
                                                        ...
                                                        <td className="class-cell" style={{ '--class-color': classColor } as React.CSSProperties}>{getClassName(entry.class_used, language)}</td>
                                                        <td className={`cause-cell ${causeClass}`}>{translateDeathCause(entry.death_cause || '', language)}</td>
                                                        <td className="date">{formatDate(entry.completed_at, language, entry.timezone_offset)}</td>
                    ...
                    <div className="leaderboard-content meta-content">
                        {loading ? (
                            ...
                            <LeaderboardStatistics
                                ...
                                getClassName={(id) => getClassName(id, language)}
                                translateDeathCause={(cause) => translateDeathCause(cause, language)}
                            />
                        )}
                    </div>
                )}
