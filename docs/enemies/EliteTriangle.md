...
When the Elite Triangle is within **600 units** of the player and its skill is off cooldown, it enters a **0.5-second cast state**.
- **Movement**: The enemy stops completely during this phase.
...
### 3. Tactical Dash
After the cast phase, the Elite Triangle locks onto a target position (overshooting the player by 200 units) and performs a high-speed rush for up to **1.5 seconds**.
...
### 4. Cooldown
After completing a dash, the Elite Triangle enters a cooldown period of **5 to 7 seconds** (randomized) before it can initiate another cast and dash sequence.
